...
class CheckMails extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            $folder = $client->getFolder('[Gmail]/Primary');
        ...
        while (true) {
            ...
            try {
                ...
                // Establecer la fecha límite (últimas 12 horas)
                $last12Hours = Carbon::now()->subHours(12);
                ...
                do {
                    ...
                    foreach ($messages as $message) {
                        ...
                        $messageDate = Carbon::parse($message->getDate());

                        // Verificar si el correo fue recibido en las últimas 12 horas
                        if ($messageDate->greaterThanOrEqualTo($last12Hours)) {
                            $this->info('Correo recibido en las últimas 12 horas: ' . $message->getSubject());
                            ...
                            $this->info('Correo fuera del rango de 12 horas: ' . $message->getSubject());
                        }
                    }
