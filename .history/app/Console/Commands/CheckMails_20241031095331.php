...
class CheckMails extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            $tenMinutesAgo = Carbon::now()->subHours(10)->timezone('UTC'); // Asegurar la zona horaria
                        ...
                        foreach ($message->getAttachments() as $attachment) {
                            ...
                            if (strtolower($attachment->getExtension()) == 'json') {
                                ...
                                foreach ($data['inspecciones'] as $inspeccion) {
                                    ...
                                    Auto::updateOrInsert(
                                        ['id_auto' => $autoData['Unidad']['id_auto']], // Condición para actualizar o insertar
                                        [
                                ...
                                $this->info('Datos del JSON procesados y guardados correctamente.');
                                try {
