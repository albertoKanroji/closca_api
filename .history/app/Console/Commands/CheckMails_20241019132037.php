    ...
    public function handle()
    {
        ...
        while (true) {
            ...
            try {
                ...
                $today = Carbon::today()->toDateString(); // Formato 'Y-m-d'

                // Filtrar correos desde la fecha de hoy
                $messages = $folder->query()->unseen()->since($today)->get();
                $this->info(count($messages) . ' correos no leídos encontrados para el día de hoy.');
            } catch (\Exception $e) {
